...
<div class="container">
    ...
    <div class="row body">
        <form class="form-horizontal" action="updateemp" method="post">
            <input hidden value="${emp.emp_id}" name="emp_id">
                    ...
                    <select class="form-control" name="dept_id">
                        <c:forEach var="dept" items="${deptlist}">
                            <option value="${dept.dept_id}"
                                    <c:if test="${emp.dept_name == dept.name}"> selected="${emp.dept_name}"</c:if>
                            >${dept.name}</option>
                        </c:forEach>
                    </select>
